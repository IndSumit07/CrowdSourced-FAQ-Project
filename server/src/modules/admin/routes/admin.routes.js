...
const editFaqSchema = z.object({
  ...
  sectionId: z.string().regex(/^[0-9a-fA-F]{24}$/).optional().nullable(),
  responseId: z.string().regex(/^[0-9a-fA-F]{24}$/).optional().nullable(), // ID of the selected contributor response
});
